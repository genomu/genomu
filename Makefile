...
stop:
	@kill -9 `cat data/spawn1/genomu.pid` `cat data/spawn2/genomu.pid` `cat data/spawn3/genomu.pid`
	@rm -f data/spawn1/genomu.pid data/spawn2/genomu.pid data/spawn3/genomu.pid
